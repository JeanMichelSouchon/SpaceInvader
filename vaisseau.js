...
function lancerPartie() {
    ...
    celluleVaisseau.innerHTML = '<img src="vaisseau.gif">';// on remplace l'image
}
...
function effaceShip() {
    ...
    celluleVaisseau.innerHTML = '<img src="vide.png">';// on change l'image ou se trouve le vaisseau par du vide
}

// Fonction pour afficher le vaisseau à sa nouvelle position
function afficheShip() {
    var celluleVaisseau = document.querySelector('tr:nth-child(' + (posShipY + 1) + ') td:nth-child(' + (posShipX + 1) + ')');
    celluleVaisseau.innerHTML = '<img src="vaisseau.gif">'; // on change l'image ou se trouve le vaisseau par le vaisseau
}
